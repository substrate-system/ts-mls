...
import { protect, unprotectPrivateMessage, protectApplicationData, protectProposal } from '../../src/messageProtection'
...
import type { AuthenticatedContent } from '../../src/authenticatedContent'
